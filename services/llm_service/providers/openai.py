...
This module contains the OpenAI provider implementation for using GPT models.
"""
...
class OpenAIProvider(LLMProvider):
    """
    OpenAI API provider implementation for GPT models
    """
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        return {
            ...
            "max_tokens": 128000,  # GPT-4 Turbo has 128k context window
